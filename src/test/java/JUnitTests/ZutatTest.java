 ...
 * @author Anna Karle
 * @see com.example.application.data.entity.Zutat
...
public class ZutatTest {
	...
	/** In der Methode setUp() werden  ZutatService und EinheitService erstellt und eine neue Einheit gespeichert
	 * 
	 * @throws Exception
	 */
	...
	/** Methode testZutatUpdate() testet die Methode updateZutat aus der Klasse ZutatService
	 * 
	 */
	@Test 
	...
	/** Methode testZutatenSuche() speichert neue Zutaten in der Datenbank, findet diese nach Suchwort
	 * und gibt in einer Liste zurück. Dadurch wird die Methode searchZutatenByFilterText getestet
	 */
	@Test
